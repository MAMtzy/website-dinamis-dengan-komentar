...
<head>
    ...
    <title>An Namiroh Travelindo</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="http://localhost/ci-komen1/">home</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    <div class="container">
        ...
        <hr>Durasi       :<?php echo $waktu;?>
        <br>Hotel        :<?php echo $content_body;?>
        <br>Harga Mulai  :<?php echo $harga;?>
    ...
    <div class="container">
        <div class="w3-panel w3-pale-blue w3-leftbar w3-border-blue">
            <p>
                ...
                <br><?php echo $utama->comment_isi?></p>
        </div>
    </div>
        <?php
            $content_id = $content_id;
